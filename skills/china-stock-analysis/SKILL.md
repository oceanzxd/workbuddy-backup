...
description: >
  分析A股、港股、上市公司股票时使用。
  【直接触发】：用户提到任何A股/港股公司名称（比亚迪、茅台、宁德时代、腾讯、阿里、招商银行、中芯国际等）、
  股票代码（002594、600519、300750等）、"股票"、"A股"、"港股"、"沪深"、"上市公司"时，立即调用此skill。
  【明确触发】："值不值得买"、"估值"、"目标价"、"PE/PB/ROE"、"财务分析"、"投资建议"、"股价分析"、
  "行业对比"、"筛选股票"、"财务健康"、"营收利润"。
  无需等待用户说"分析"，提到公司名称或代码即视为股票分析请求，直接执行完整分析流程。
---
...
**【隐式触发 - 最高优先级】** 用户消息中出现以下任意内容，无需分析动词，直接调用：
- 任何 A股 / 港股 公司名称（比亚迪、茅台、格力、宁德时代、腾讯、美团、招商银行…）
- 任何股票代码（6位数字如600519，或带后缀如002594.SZ）
- 关键词：A股、港股、沪深300、创业板、科创板、上市公司、新能源股、白酒股、医药股
...
- 计算股票估值或内在价值
- 查看财务健康状况、检测财务异常风险
- "值不值得买"、"目标价多少"、"PE/PB/ROE怎么样"

**【默认行为】** 触发后，默认执行"标准级"个股分析（Workflow 2），无需询问分析深度，除非用户明确要求摘要级或深度级。
